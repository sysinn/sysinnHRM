    ...
    <main class="flex-1 p-4 md:p-6">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex items-center gap-4 mb-6">
                ...
                <a href="{{ route('payroll.show', $payroll->id) }}" class="p-2 hover:bg-gray-100 rounded-lg transition-colors">
                    <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-1">Update payroll record for {{ $payroll->employee->first_name ?? '' }} {{ $payroll->employee->last_name ?? '' }}</p>
                </div>
            </div>
                ...
                <form action="{{ route('payroll.update', $payroll->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="employee_id" required class="form-select w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#0057D8] focus:border-transparent transition-all">
                            ...
                            @foreach($employees as $emp)
                                <option value="{{ $emp->id }}" {{ $payroll->employee_id == $emp->id ? 'selected' : '' }}>{{ $emp->first_name }} {{ $emp->last_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="border-t border-gray-100 pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">Rs.</span>
                                    <input type="number" name="allowances" step="0.01" placeholder="0.00" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">Rs.</span>
                                    <input type="number" name="overtime_pay" step="0.01" placeholder="0.00" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">Rs.</span>
                                    <input type="number" name="bonus" step="0.01" placeholder="0.00" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">Rs.</span>
                                    <input type="number" name="increment" step="0.01" placeholder="0.00" 
                                        value="{{ old('increment', $payroll->increment) }}"
                                        class="form-input w-full pl-12 pr-4 py-2.5 border border-gray-200 rounded-lg transition-all">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="increment_reason" placeholder="e.g., Annual increment, Promotion"
                                    value="{{ old('increment_reason', $payroll->increment_reason) }}"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">Rs.</span>
                                    <input type="number" name="deductions" step="0.01" placeholder="0.00" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="payment_method" class="form-select w-full px-4 py-2.5 border border-gray-200 rounded-lg transition-all">
                                    ...
                                    <option value="Cheque" {{ $payroll->payment_method == 'Cheque' ? 'selected' : '' }}>Cheque</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="payment_status" class="form-select w-full px-4 py-2.5 border border-gray-200 rounded-lg transition-all">
                                    ...
                                    <option value="Failed" {{ $payroll->payment_status == 'Failed' ? 'selected' : '' }}>Failed</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-100 pt-6">
                        ...
                        <textarea name="remarks" rows="3" placeholder="Add any additional notes..." 
                            class="form-input w-full px-4 py-2.5 border border-gray-200 rounded-lg transition-all">{{ old('remarks', $payroll->remarks) }}</textarea>
                    </div>
